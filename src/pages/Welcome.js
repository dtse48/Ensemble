    ...
    return (
        <div style={{marginTop:"50px",textAlign:"center"}}>
            <Card.Group centered style={{marginTop:"100px"}}>
                <Card style={{width:"20%",height:"400px",backgroundColor:"#18db9d"}} className={classes.cards}>
                ...
                <Card style={{width:"20%",height:"400px",backgroundColor:"#f7e131"}} className={classes.cards}>
                ...
                <Card style={{width:"20%",height:"400px",backgroundColor:"#0077ff"}} className={classes.cards}>
